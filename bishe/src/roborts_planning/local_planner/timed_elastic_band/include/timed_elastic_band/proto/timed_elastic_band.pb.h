...
namespace google {
namespace protobuf {
template<> ::roborts_local_planner::Collision* Arena::CreateMaybeMessage<::roborts_local_planner::Collision>(Arena*);
...
class Robot : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_local_planner.Robot) */ {
 public:
  ...
  bool has_jerk_lim_x() const;
  void clear_jerk_lim_x();
  static const int kJerkLimXFieldNumber = 8;
  float jerk_lim_x() const;
  void set_jerk_lim_x(float value);

  // optional float jerk_lim_y = 9;
  bool has_jerk_lim_y() const;
  void clear_jerk_lim_y();
  static const int kJerkLimYFieldNumber = 9;
  float jerk_lim_y() const;
  void set_jerk_lim_y(float value);

  // optional float jerk_lim_theta = 10;
  bool has_jerk_lim_theta() const;
  void clear_jerk_lim_theta();
  static const int kJerkLimThetaFieldNumber = 10;
  float jerk_lim_theta() const;
  void set_jerk_lim_theta(float value);

  // optional float min_turning_radius = 11;
  bool has_min_turning_radius() const;
  void clear_min_turning_radius();
  static const int kMinTurningRadiusFieldNumber = 11;
  ...
  static const int kCmdAngleInsteadRotvelFieldNumber = 13;
 ...
 private:
  ...
  void set_has_jerk_lim_x();
  void clear_has_jerk_lim_x();
  void set_has_jerk_lim_y();
  void clear_has_jerk_lim_y();
  void set_has_jerk_lim_theta();
  void clear_has_jerk_lim_theta();
...
class Collision : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_local_planner.Collision) */ {
 public:
  Collision();
  virtual ~Collision();
  ...
  // @@protoc_insertion_point(class_scope:roborts_local_planner.Collision)
 private:
  void set_has_min_obstacle_dist();
  void clear_has_min_obstacle_dist();
  void set_has_inflation_dist();
...
class Optimization : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_local_planner.Optimization) */ {
 public:
  ...
  bool has_weight_jerk_lim_x() const;
  void clear_weight_jerk_lim_x();
  static const int kWeightJerkLimXFieldNumber = 12;
  float weight_jerk_lim_x() const;
  void set_weight_jerk_lim_x(float value);

  // optional float weight_jerk_lim_y = 13;
  bool has_weight_jerk_lim_y() const;
  void clear_weight_jerk_lim_y();
  static const int kWeightJerkLimYFieldNumber = 13;
  float weight_jerk_lim_y() const;
  void set_weight_jerk_lim_y(float value);

  // optional float weight_jerk_lim_theta = 14;
  bool has_weight_jerk_lim_theta() const;
  void clear_weight_jerk_lim_theta();
  static const int kWeightJerkLimThetaFieldNumber = 14;
  float weight_jerk_lim_theta() const;
  void set_weight_jerk_lim_theta(float value);

  // optional float weight_kinematics_nh = 15;
  bool has_weight_kinematics_nh() const;
  void clear_weight_kinematics_nh();
  static const int kWeightKinematicsNhFieldNumber = 15;
  ...
  static const int kWeightKinematicsForwardDriveFieldNumber = 16;
  ...
  static const int kWeightKinematicsTurningRadiusFieldNumber = 17;
  ...
  static const int kWeightOptimaltimeFieldNumber = 18;
  ...
  static const int kWeightObstacleFieldNumber = 19;
  ...
  static const int kWeightInflationFieldNumber = 20;
  ...
  static const int kWeightDynamicObstacleFieldNumber = 21;
  ...
  static const int kWeightAdaptFactorFieldNumber = 23;
  ...
  static const int kWeightPreferRotdirFieldNumber = 24;
  float weight_prefer_rotdir() const;
  void set_weight_prefer_rotdir(float value);

  // optional float weight_collision = 25;
  bool has_weight_collision() const;
  void clear_weight_collision();
  static const int kWeightCollisionFieldNumber = 25;
  float weight_collision() const;
  void set_weight_collision(float value);

  // optional float weight_collision_inflation = 26;
  bool has_weight_collision_inflation() const;
  void clear_weight_collision_inflation();
  static const int kWeightCollisionInflationFieldNumber = 26;
  float weight_collision_inflation() const;
  void set_weight_collision_inflation(float value);
 ...
 private:
  ...
  void set_has_weight_jerk_lim_x();
  void clear_has_weight_jerk_lim_x();
  void set_has_weight_jerk_lim_y();
  void clear_has_weight_jerk_lim_y();
  void set_has_weight_jerk_lim_theta();
  void clear_has_weight_jerk_lim_theta();
  ...
  void set_has_weight_collision();
  void clear_has_weight_collision();
  void set_has_weight_collision_inflation();
  void clear_has_weight_collision_inflation();
  ...
  float weight_jerk_lim_x_;
  float weight_jerk_lim_y_;
  float weight_jerk_lim_theta_;
  ...
  float weight_collision_;
  float weight_collision_inflation_;
  friend struct ::protobuf_timed_5felastic_5fband_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Config : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_local_planner.Config) */ {
 public:
  ...
  static const int kRobotTypeFieldNumber = 9;
  ...
  bool has_collision_opt() const;
  void clear_collision_opt();
  static const int kCollisionOptFieldNumber = 6;
  private:
  const ::roborts_local_planner::Collision& _internal_collision_opt() const;
  public:
  const ::roborts_local_planner::Collision& collision_opt() const;
  ::roborts_local_planner::Collision* release_collision_opt();
  ::roborts_local_planner::Collision* mutable_collision_opt();
  void set_allocated_collision_opt(::roborts_local_planner::Collision* collision_opt);

  // optional .roborts_local_planner.Optimization optimize_info = 7;
  bool has_optimize_info() const;
  void clear_optimize_info();
  static const int kOptimizeInfoFieldNumber = 7;
  private:
  ...
  void clear_hcp_opt();
  static const int kHcpOptFieldNumber = 8;
  private:
  ...
  static const int kRecoveryInfoFieldNumber = 10;
  private:
 ...
 private:
  ...
  void set_has_collision_opt();
  void clear_has_collision_opt();
  ...
  ::roborts_local_planner::Collision* collision_opt_;
...
// optional float jerk_lim_x = 8;
inline bool Robot::has_jerk_lim_x() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void Robot::set_has_jerk_lim_x() {
  _has_bits_[0] |= 0x00000080u;
}
inline void Robot::clear_has_jerk_lim_x() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void Robot::clear_jerk_lim_x() {
  jerk_lim_x_ = 0;
  clear_has_jerk_lim_x();
}
inline float Robot::jerk_lim_x() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Robot.jerk_lim_x)
  return jerk_lim_x_;
}
inline void Robot::set_jerk_lim_x(float value) {
  set_has_jerk_lim_x();
  jerk_lim_x_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Robot.jerk_lim_x)
}

// optional float jerk_lim_y = 9;
inline bool Robot::has_jerk_lim_y() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void Robot::set_has_jerk_lim_y() {
  _has_bits_[0] |= 0x00000100u;
}
inline void Robot::clear_has_jerk_lim_y() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void Robot::clear_jerk_lim_y() {
  jerk_lim_y_ = 0;
  clear_has_jerk_lim_y();
}
inline float Robot::jerk_lim_y() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Robot.jerk_lim_y)
  return jerk_lim_y_;
}
inline void Robot::set_jerk_lim_y(float value) {
  set_has_jerk_lim_y();
  jerk_lim_y_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Robot.jerk_lim_y)
}

// optional float jerk_lim_theta = 10;
inline bool Robot::has_jerk_lim_theta() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void Robot::set_has_jerk_lim_theta() {
  _has_bits_[0] |= 0x00000200u;
}
inline void Robot::clear_has_jerk_lim_theta() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void Robot::clear_jerk_lim_theta() {
  jerk_lim_theta_ = 0;
  clear_has_jerk_lim_theta();
}
inline float Robot::jerk_lim_theta() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Robot.jerk_lim_theta)
  return jerk_lim_theta_;
}
inline void Robot::set_jerk_lim_theta(float value) {
  set_has_jerk_lim_theta();
  jerk_lim_theta_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Robot.jerk_lim_theta)
}
...
// optional float min_obstacle_dist = 1;
inline bool Collision::has_min_obstacle_dist() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Collision::set_has_min_obstacle_dist() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Collision::clear_has_min_obstacle_dist() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Collision::clear_min_obstacle_dist() {
  min_obstacle_dist_ = 0;
  clear_has_min_obstacle_dist();
}
inline float Collision::min_obstacle_dist() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Collision.min_obstacle_dist)
  return min_obstacle_dist_;
}
inline void Collision::set_min_obstacle_dist(float value) {
  set_has_min_obstacle_dist();
  min_obstacle_dist_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Collision.min_obstacle_dist)
}

// optional float inflation_dist = 2;
inline bool Collision::has_inflation_dist() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Collision::set_has_inflation_dist() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Collision::clear_has_inflation_dist() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Collision::clear_inflation_dist() {
  inflation_dist_ = 0;
  clear_has_inflation_dist();
}
inline float Collision::inflation_dist() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Collision.inflation_dist)
  return inflation_dist_;
}
inline void Collision::set_inflation_dist(float value) {
  set_has_inflation_dist();
  inflation_dist_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Collision.inflation_dist)
}
...
// optional float weight_jerk_lim_x = 12;
inline bool Optimization::has_weight_jerk_lim_x() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void Optimization::set_has_weight_jerk_lim_x() {
  _has_bits_[0] |= 0x00000800u;
}
inline void Optimization::clear_has_weight_jerk_lim_x() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void Optimization::clear_weight_jerk_lim_x() {
  weight_jerk_lim_x_ = 0;
  clear_has_weight_jerk_lim_x();
}
inline float Optimization::weight_jerk_lim_x() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Optimization.weight_jerk_lim_x)
  return weight_jerk_lim_x_;
}
inline void Optimization::set_weight_jerk_lim_x(float value) {
  set_has_weight_jerk_lim_x();
  weight_jerk_lim_x_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Optimization.weight_jerk_lim_x)
}

// optional float weight_jerk_lim_y = 13;
inline bool Optimization::has_weight_jerk_lim_y() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void Optimization::set_has_weight_jerk_lim_y() {
  _has_bits_[0] |= 0x00001000u;
}
inline void Optimization::clear_has_weight_jerk_lim_y() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void Optimization::clear_weight_jerk_lim_y() {
  weight_jerk_lim_y_ = 0;
  clear_has_weight_jerk_lim_y();
}
inline float Optimization::weight_jerk_lim_y() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Optimization.weight_jerk_lim_y)
  return weight_jerk_lim_y_;
}
inline void Optimization::set_weight_jerk_lim_y(float value) {
  set_has_weight_jerk_lim_y();
  weight_jerk_lim_y_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Optimization.weight_jerk_lim_y)
}

// optional float weight_jerk_lim_theta = 14;
inline bool Optimization::has_weight_jerk_lim_theta() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void Optimization::set_has_weight_jerk_lim_theta() {
  _has_bits_[0] |= 0x00002000u;
}
inline void Optimization::clear_has_weight_jerk_lim_theta() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void Optimization::clear_weight_jerk_lim_theta() {
  weight_jerk_lim_theta_ = 0;
  clear_has_weight_jerk_lim_theta();
}
inline float Optimization::weight_jerk_lim_theta() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Optimization.weight_jerk_lim_theta)
  return weight_jerk_lim_theta_;
}
inline void Optimization::set_weight_jerk_lim_theta(float value) {
  set_has_weight_jerk_lim_theta();
  weight_jerk_lim_theta_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Optimization.weight_jerk_lim_theta)
}
...
// optional float weight_collision = 25;
inline bool Optimization::has_weight_collision() const {
  return (_has_bits_[0] & 0x01000000u) != 0;
}
inline void Optimization::set_has_weight_collision() {
  _has_bits_[0] |= 0x01000000u;
}
inline void Optimization::clear_has_weight_collision() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void Optimization::clear_weight_collision() {
  weight_collision_ = 0;
  clear_has_weight_collision();
}
inline float Optimization::weight_collision() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Optimization.weight_collision)
  return weight_collision_;
}
inline void Optimization::set_weight_collision(float value) {
  set_has_weight_collision();
  weight_collision_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Optimization.weight_collision)
}

// optional float weight_collision_inflation = 26;
inline bool Optimization::has_weight_collision_inflation() const {
  return (_has_bits_[0] & 0x02000000u) != 0;
}
inline void Optimization::set_has_weight_collision_inflation() {
  _has_bits_[0] |= 0x02000000u;
}
inline void Optimization::clear_has_weight_collision_inflation() {
  _has_bits_[0] &= ~0x02000000u;
}
inline void Optimization::clear_weight_collision_inflation() {
  weight_collision_inflation_ = 0;
  clear_has_weight_collision_inflation();
}
inline float Optimization::weight_collision_inflation() const {
  // @@protoc_insertion_point(field_get:roborts_local_planner.Optimization.weight_collision_inflation)
  return weight_collision_inflation_;
}
inline void Optimization::set_weight_collision_inflation(float value) {
  set_has_weight_collision_inflation();
  weight_collision_inflation_ = value;
  // @@protoc_insertion_point(field_set:roborts_local_planner.Optimization.weight_collision_inflation)
}
...
// optional .roborts_local_planner.Collision collision_opt = 6;
inline bool Config::has_collision_opt() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void Config::set_has_collision_opt() {
  _has_bits_[0] |= 0x00000020u;
}
inline void Config::clear_has_collision_opt() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void Config::clear_collision_opt() {
  if (collision_opt_ != NULL) collision_opt_->Clear();
  clear_has_collision_opt();
}
inline const ::roborts_local_planner::Collision& Config::_internal_collision_opt() const {
  return *collision_opt_;
}
inline const ::roborts_local_planner::Collision& Config::collision_opt() const {
  const ::roborts_local_planner::Collision* p = collision_opt_;
  // @@protoc_insertion_point(field_get:roborts_local_planner.Config.collision_opt)
  return p != NULL ? *p : *reinterpret_cast<const ::roborts_local_planner::Collision*>(
      &::roborts_local_planner::_Collision_default_instance_);
}
inline ::roborts_local_planner::Collision* Config::release_collision_opt() {
  // @@protoc_insertion_point(field_release:roborts_local_planner.Config.collision_opt)
  clear_has_collision_opt();
  ::roborts_local_planner::Collision* temp = collision_opt_;
  collision_opt_ = NULL;
  return temp;
}
inline ::roborts_local_planner::Collision* Config::mutable_collision_opt() {
  set_has_collision_opt();
  if (collision_opt_ == NULL) {
    auto* p = CreateMaybeMessage<::roborts_local_planner::Collision>(GetArenaNoVirtual());
    collision_opt_ = p;
  }
  // @@protoc_insertion_point(field_mutable:roborts_local_planner.Config.collision_opt)
  return collision_opt_;
}
inline void Config::set_allocated_collision_opt(::roborts_local_planner::Collision* collision_opt) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete collision_opt_;
  }
  if (collision_opt) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      collision_opt = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, collision_opt, submessage_arena);
    }
    set_has_collision_opt();
  } else {
    clear_has_collision_opt();
  }
  collision_opt_ = collision_opt;
  // @@protoc_insertion_point(field_set_allocated:roborts_local_planner.Config.collision_opt)
}
